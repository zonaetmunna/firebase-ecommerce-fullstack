    ...
    getDefaultMiddleware({
      serializableCheck: {
        ignoredActions: [
          ...
          "persist/PURGE",
          "persist/REGISTER",
          // Ignore Firebase Timestamp actions
          "user/getAllUsers/fulfilled",
          "user/getAllUsers/pending",
          "user/getUserStats/fulfilled",
          "user/getUserStats/pending",
          "user/login/fulfilled",
          "user/signup/fulfilled",
          "user/signInWithGoogle/fulfilled",
          "user/signInWithFacebook/fulfilled",
          "user/refreshUserData/fulfilled",
        ],
        ignoredPaths: [
          // Ignore Firebase Timestamp paths in state
          "auth.currentUser.createdAt",
          "auth.currentUser.updatedAt",
          "auth.users",
          "admin.users",
          "product.products",
          "category.categories",
        ...
        ignoredActionsPaths: [
          // Ignore Firebase Timestamp paths in actions
          "payload.createdAt",
          "payload.updatedAt",
          "payload.0.createdAt",
          "payload.0.updatedAt",
